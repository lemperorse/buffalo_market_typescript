            ...
            <div class="col-md-2 col-sm-3 col-6 cursor-pointer" v-for="i in 18" @click="$router.push('/user/productdetail/')">
                <v-hover v-slot:default="{ hover }">
                    ...
                    <div class="mx-auto card rounded-lg bg-white hover:shadow-lg overflow-hidden border">
                        <v-img class="white--text align-end" height="150px" src="https://images.pexels.com/photos/5644323/pexels-photo-5644323.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940">
                            <v-expand-transition>
                        ...
                        <div class="p-4">
                            ...
                            <h4 class="font-semibold text-lg leading-tight truncate mb-1 text-indigo-600 group-hover:text-gray-900">องุ่น</h4>
