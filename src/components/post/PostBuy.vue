        ...
        <v-row dense>
            ...
            <v-col cols="12" sm="4" class="relative ">
                <div class="text-right">
                    <button type="submit" class="w-full btn purple1 md:w-1/2 mb-3 mt-1 rounded p-3" @click="$router.push(`/user/addpostbuy`)">
                ...
                <v-hover v-slot:default="{ hover }">
                    <v-card class="rounded-lg" height="370px" width="200px">
                        ...
                        <div class="p-4">
                            ...
                            <div class=" flex ">
                                <v-btn type="submit " @click="$router.push(`/user/postbuyedit/?product=${product.id}`)" rounded large class="w-full bgbtn" dark>
