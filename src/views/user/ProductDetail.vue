    ...
    <div class="container mx-auto">
        <div class="w-full mb-6">
            <ol class="flex text-gray-700 bg-gray-300 rounded-full py-2 px-2">
                <li class="px-2"><a href="/" class="hover:underline"><v-icon>mdi-home</v-icon> {{_lang('หน้าแรก','Home','家')}}</a></li>
                <li class="text-gray-500 select-none">/</li>
                <li class="px-2 text-green-600"><v-icon>mdi-shopping-outline</v-icon> {{_lang('รายละเอียดสินค้า','Product details','產品詳情')}} : {{product.name}}</li>
            </ol>
        </div>
        <ProductDetail />
    </div>
