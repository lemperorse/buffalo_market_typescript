            ...
            <div :class="`w-full ${(advanceSearch)?'md:w-3/4':''} md:pl-6 animate__animated  animate__bounceInRight` " >
                <div class="w-full p-6"  >
                    <v-toolbar color="transparent" flat>
                      ...
                      <div class="pt-6">
                    <h2 class="text-xl md:text-4xl font-bold"> {{_lang('ประกาศ ซื้อ-ขาย','Buy-Sell announcement','买卖公告')}}</h2> 
                    <p>{{_lang('การประกาศซื้อขาย สินค้าต่างๆ ในระบบ','Announcing the purchase of various products in the system','宣布购买各种产品')}} </p> 
                        </div> 
                    </div>
                    <v-spacer></v-spacer>
