...
<div>
    <v-toolbar flat color="transparent">
        ...
        <v-spacer></v-spacer>
        <v-btn rounded large outlined @click="gotoMyShop()" color="orange">ไปยังเมนูหน้าร้าน</v-btn>
    </v-toolbar>
    ...
    <div v-if="saller">
        ...
        <form v-if="response" @submit.prevent="update()">
            <div class="flex flex-wrap">
                ...
                <v-text-field required rounded class="w-full " v-model="form.farm_address" filled :label="_lang('ที่อยู่ร้านค้า','Shop address','店鋪地址')" prepend-inner-icon="mdi-home-city-outline"></v-text-field>
                <v-text-field readonly rounded class="w-full items-end" :value="CityFrom" @click="openCityDialog " @focus="openCityDialog" filled :label="_lang('จังหวัดที่อยู่ร้านค้า','province, shop address','省、店地址')" prepend-inner-icon="mdi-home-group"></v-text-field>
