...
<div class="bg-gray-100 h-full">
    <div class="container mx-auto ">
        <ol class="flex text-gray-700 bg-gray-200 rounded-full py-2 px-2 mt-10 items-center">
            ...
            <li class="text-gray-500 select-none">/</li>
            <li class="px-2 text-sm text-yellow-600">{{_lang('เพิ่มประกาศขาย','Add Announcement','添加公告')}}</li>
        </ol>
                    ...
                    <div class="px-4 py-5 flex-auto">
                        <div class="text-center">
                            <div class="text-white">
                                <i class="fas fa-store-alt text-xl mr-1"></i>{{_lang('เพิ่มประกาศขาย','Add product','添加產品')}}
                            </div>
                        </div>
                    </div>
                </div>
...
import AddPostSell from "@/components/post/AddPostSell"
export default {
    name: "post-edit-page",
    components: {
        AddPostSell
