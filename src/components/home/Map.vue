<template>
  <div class="flex bg-map justify-center">
    <div class="p-12 text-center max-w-2xl">
        <i class="em em-world_map text-6xl" aria-role="presentation" aria-label=""></i><br>
        <div class="md:text-3xl text-3xl font-bold">{{_lang('ค้นหาสถานที่สำคัญ ?','Find landmarks ?','看地标 ?')}} </div>
