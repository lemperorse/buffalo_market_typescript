        ...
        <div class="row">
                ...
                <v-hover v-slot:default="{ hover }">
                    ...
                    <div class="mx-auto card rounded-lg bg-white hover:shadow-lg overflow-hidden border">
                        ...
                        <!-- <v-card-text class="text--primary">
                            <div class="text-xl">
                                <a href="/productdetail" style="text-decoration: none">ควายเผือก</a>
                            </div>
                            <div class="text-lg text-gray-600 font-light">
                                <span class="mdi mdi-map-marker"></span> เชียงใหม่
                            </div>
                            <div class="text-lg text-orange-600 font-bold">฿12,000</div>
                            <p class="text-gray-600 mt-2">
                                สีเผือก พันธุ์ไทย สูง 120 ซม. <br />อายุ 5 ปี
                            </p>
                        </v-card-text> -->
                    </div>
                    <!-- </v-card> -->
            ...
            <div class="col-md-2 col-sm-3 col-xs-12 cursor-pointer" v-for="i in 6" @click="$router.push('/user/productdetail/')">
                <v-hover v-slot:default="{ hover }">
                    <!-- <v-card class="mx-auto" color="grey lighten-4" max-width="600"> -->
                    <div class="mx-auto card rounded-lg bg-white hover:shadow-lg overflow-hidden border">
                        <v-img class="white--text align-end" height="150px" src="https://images.pexels.com/photos/3696170/pexels-photo-3696170.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940">
                            <v-expand-transition>
                                <div v-if="hover" class="d-flex transition-fast-in-fast-out white darken-2 v-card--reveal display-3 black--text" style="height: 100%">
                                    <v-btn v-if="hover" href="/#/user/productdetail/" class="" outlined>ดูรายละเอียด</v-btn>
                                </div>
                        ...
                        <div class="p-4">
                            ...
                            <h4 class="font-semibold text-lg leading-tight truncate mb-1 text-indigo-600 group-hover:text-gray-900">ปุ๋ยคอก</h4>
                            <div class=" text-orange-600 font-bold mb-1">฿ 12,000</div>
                            <div class="text-sm text-gray-600 font-light mb-1">
                                <span class="fas fa-map-marker-alt"></span> เชียงใหม่
                            </div>
            ...
            <div class="col-md-2 col-sm-3 col-xs-12 cursor-pointer" v-for="i in 6" @click="$router.push('/user/productdetail/')">
                <v-hover v-slot:default="{ hover }">
                    <!-- <v-card class="mx-auto" color="grey lighten-4" max-width="600"> -->
                    <div class="mx-auto card rounded-lg bg-white hover:shadow-lg overflow-hidden border ">
                        <v-img class="white--text align-end" height="150px" src="https://images.pexels.com/photos/5806221/pexels-photo-5806221.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940">
                            <v-expand-transition>
                                <div v-if="hover" class="d-flex transition-fast-in-fast-out white darken-2 v-card--reveal display-3 black--text" style="height: 100%">
                                    <v-btn v-if="hover" href="/#/user/productdetail/" class="" outlined>ดูรายละเอียด</v-btn>
                                </div>
                        ...
                        <div class="p-4">
                            ...
                            <h4 class="font-semibold text-lg leading-tight truncate mb-1 text-indigo-600 group-hover:text-gray-900">แอปเปิ้ล</h4>
                            <div class=" text-orange-600 font-bold mb-1">฿ 12,000</div>
                            <div class="text-sm text-gray-600 font-light mb-1">
                                <span class="fas fa-map-marker-alt"></span> เชียงใหม่
                            </div>
