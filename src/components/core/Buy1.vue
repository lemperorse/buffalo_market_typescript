                    ...
                    <v-expansion-panel >
                        ...
                        <v-expansion-panel-content class="pt-4 rounded-lg ">
                            ...
                            <p class="p-3 text-xl font-bold">
                                {{_lang('ประกาศซื้อ','Buy announcement','购买公告')}}
                            </p>
            ...
            <div :class="`w-full ${(advanceSearch)?'md:w-3/4':''} md:pl-6 animate__animated  animate__bounceInRight` " >
                <div class="w-full p-6"  >
                    <v-toolbar color="transparent" flat>
                        ...
                        <i class="mr-4 text-xl md:text-5xl em em-shopping_bags" aria-role="presentation" aria-label=""></i>
                      <div class="pt-6">
                    <h2 class="text-xl md:text-4xl font-bold"> {{_lang('ประกาศ ซื้อ','Buy announcement','购买公告')}}</h2>
                    <h2 class="text-xl md:text-2xl font-bold text-red-500"> {{_lang('หากคุณต้องการรับซื้อสินค้าสินค้า','If you want to buy products','如果您想购买产品')}}</h2>
                    <p>{{_lang('การประกาศซื้อ สินค้าต่างๆ ในระบบ','Announcing the purchase of various products in the system','宣布购买各种产品')}} </p> 
                        </div> 
                    </div>
                    <v-spacer></v-spacer>
