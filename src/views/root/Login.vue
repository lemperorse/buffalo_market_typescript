...
<div class="h-full w-full flex flex-col justify-center items-center pt-10 pb-10 md:pb-0 md:pt-0 bg-gray-100">
    <v-card class="m-8 md:w-96 rounded-lg">
        <v-card-title class="bg1"> 
            <h2 class="text-sm text-white">{{_lang('ยินดีต้อนรับเข้าสู่ตลาดควาย','Welcome to the Buffalo Market','歡迎來到布法羅市場')}}
            <br>   <span class="text-2xl font-semibold  text-left text-white"> {{_lang(' กรุณาเข้าสู่ระบบ','Please login','請登錄')}}</span>
            </h2><br>
         <br>
        </v-card-title>
        <v-divider></v-divider>
