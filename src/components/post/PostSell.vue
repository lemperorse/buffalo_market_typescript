        ...
        <v-row dense>
            <v-col cols="12" sm="4" class=" pt-4">
                <div class="flex rounded border-grey-light border bg-white">
                    ...
                    <input class="w-full rounded " type="text" placeholder="ค้นหาสินค้าในประกาศขายของฉัน">
                </div>
                ...
                <v-hover v-slot:default="{ hover }">
                    ...
                    <div class="mx-auto card rounded-lg bg-white hover:shadow-lg overflow-hidden border">
                        ...
                        <div class="p-4">
                            ...
                            <div class="flex "> 
                                <button @click="$router.push(`/user/postselledit`)" class="w-full rounded p-1 bg-indigo-500 hover:bg-indigo-800 hover:shadow-lg focus:outline-none focus:ring-4 focus:ring-indigo-600 focus:ring-opacity-50 transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110" type="submit">
