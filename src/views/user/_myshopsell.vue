...
<div class="p-2 bg-gray-100 h-full">
    <v-container grid-list-xs>
        <ol class="flex text-gray-700 bg-gray-200 rounded-full py-2 px-2">
            ...
            <li class="text-gray-500 select-none">/</li>
            <li class="px-2 text-green-600">{{_lang('ประกาศขายของฉัน','My sale announcement','我的銷售公告')}}</li>
        </ol>
            ...
            <div>
                <v-row class="pb-6 ">
                    ...
                    <div>
                        ...
                        <v-btn @click="$router.push('/user/addpostsell')" rounded large dark color="teal darken-4"><v-icon>mdi-feather</v-icon>{{$txt.web_nav.post}}</v-btn>
                    </div>
