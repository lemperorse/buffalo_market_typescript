            ...
            <div class="w-full p-6 flex flex-row">
                <v-toolbar color="transparent" flat>
                    <div class="flex items-center h-auto"> 
                        <div class="">
                            <h2 class="text-xl md:text-2xl font-bold"> {{_lang('ประกาศ ซื้อ','Buy announcement','购买公告')}}</h2>
                    ...
                    <v-spacer></v-spacer>
                    <v-btn color="orange" dark rounded large outlined @click="$router.push('/ProductBuy')">ดูสินค้าทั้งหมด</v-btn>
                </v-toolbar>
            </div>
            <br>
