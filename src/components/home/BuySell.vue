<template>
<div>
    <v-toolbar rounded flat class="bg-beta" dark>
        <v-toolbar-title>ประกาศซื้อ-ขาย</v-toolbar-title>
    </v-toolbar>
    <v-tabs color="orange">
        <v-tab>
            <i class="em em-shopping_bags" aria-role="presentation" aria-label=""> </i>
            {{_lang('ประกาศซื้อ','Buy announcement','购买公告')}}
        </v-tab>
        <v-tab>

            <i class="em em-shopping_trolley" aria-role="presentation" aria-label=""> </i>
...
import BuyHome from '@/components/core/BuyHome.vue' 
import SellHome from '@/components/core/SellHome.vue' 
