  ...
  <div class="md:w-10/12 w-full">
    <div class="row rounded-lg overflow-hidden">
      ...
      <div class="col-md-7 col-sm-7 col-xs-12 ">
        <div class=" ">
          <p class="text-3xl mb-0 mt-2 font-bold"> {{product.name}}</p><br>

          <ShareNetwork network="facebook" :url="$server+'/buffalo_market_typescript/#'+url" 
          :title="product.name" 
          :quote="product.name "
           hashtags="ตลาดควาย,buffalomarket"
           :picture="$server+'/'+product.file1"
       
           >
            <v-btn color="primary"><v-icon>mdi-facebook</v-icon>Shere To Facebook</v-btn>
          </ShareNetwork> <br>
          ...
          <v-row wrap>
            <div class="pa-2 ml-5 ">
              <v-avatar size="65">
                ...
                <v-img v-else src="https://www.buffalomarket.agri.up.ac.th/product/6.jpg" />
              </v-avatar>
