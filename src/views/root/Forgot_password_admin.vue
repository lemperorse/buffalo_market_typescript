                    ...
                    <form>
                        <div class="relative">
                            <div class="relative flex w-full flex-wrap items-stretch mb-3 animate__animated animate__fadeInRight">
                                ...
                                <input type="text" placeholder="หมายเลขบัตรประชาชน" class="px-3 py-3 placeholder-gray-500 rounded bg-red-200 focus:bg-white focus:shadow-outline w-full pl-10" />
                            </div>
                        </div>
                        <div class="relative mt-6">
                            <div class="relative flex w-full flex-wrap items-stretch mb-3 animate__animated animate__fadeInRight">
                                ...
                                <input type="number" placeholder="หมายเลขโทรศัพท์" class="px-3 py-3 placeholder-gray-500 rounded bg-red-200 focus:bg-white focus:shadow-outline w-full pl-10" />
                            </div> 
                        </div>
